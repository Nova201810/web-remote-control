...
% This information is entered into a MATLAB(R) file named cstr_m.m with the
% following content.
%
...
% as to influence the production least, and so forth). The article in [1]
...
% and one for validation purposes, that were generated through a MATLAB
...
%% References
%
% [1] Braun, M.W., R. Ortiz-Mojica and D.E. Rivera, "Application of minimum
% crest factor multisinusoidal signals for 'plant-friendly' identification
% of nonlinear process systems," in _Control Engineering Practice_, Vol.
% 10, No. 3, 2002, pp. 301-313. 
